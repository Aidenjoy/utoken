...
export const STATIC_I18N_KEYS = [
  // 餐饮与包装工作流的动态目录、说明和输入标签。
  'Food Design',
  'Packaging Design',
  'Dish retouch',
  'Batch menu photos',
  'Meal combinations',
  'Food campaign poster',
  ...
  'Upload the required reference image',
  'Complete the required text within the character limit',
  'Select a valid design option',
  'Select a valid resolution and aspect ratio',
  'Choose between 1 and 4 images',
  'Select at least one output format',
  'Use between {{min}} and {{max}} items',
  'Use between {{min}} and {{max}} images',
  'Each item needs a unique identity',
  'Check item names, notes, images and quantities (1–4)',
  'A design run supports 1–6 images',
  'Dish {{index}}',
  'Choose 2–4 material combinations',
  'Choose distinct material combinations',
  'This material does not match the packaging form',
  'What would you like to create?',
  'Source materials',
  'Design requirements',
  'Output settings',
  'Style reference (optional)',
  'Style only; never a source for food, products or text.',
  'Campaign direction',
  'Text treatment',
  'Text-free image',
  'Short approved copy',
  'Headline',
  'Subtitle (optional)',
  'Exact price or offer (optional)',
  'Only supplied copy is used. Check all text before publishing.',
  'Background direction',
  'This run: {{count}} images',
  ...
  'SKU name',
  'Quantity (1–4)',
  'SKU color and differences',
  'Item notes',
  'Add item',
  'Output formats',
  'General-purpose ratios, not official platform specifications.',
  'Packaging form',
  ...
  'Master selected. Review settings before generating.',
  'Existing gift box (optional)',
  'Packaging master (required)',
  'Product photos (optional)',
  'Brand or Logo reference (optional)',
  'Logo reference does not guarantee pixel-perfect reproduction.',
  'Packaging brief',
  'Brand name (optional)',
  'Product name (optional)',
  'Short packaging copy (optional)',
  'No invented barcodes, ingredients, nutrition tables or certifications.',
  'Refresh scope',
  'Only the current SKU is sent with the selected master.',
  'Photographic setting',
  'Multiple output formats',
  'Use as packaging master',
  'One real dish photo; optional style reference.',
  'Improve light and background while retaining the dish and portion.',
  '1–6 dishes, one photo and separate notes per dish.',
  'One consistent menu photo per dish, in list order.',
  '2–4 real dishes or drinks with confirmed quantities.',
  'One complete meal composition, without extra items.',
  '1–4 real dishes; optional approved headline and offer.',
  'A simple campaign poster or a text-free background.',
  'A packaging brief; product and brand photos are optional.',
  'Independent visual directions, even without an existing package.',
  'One existing package; choose the area to update.',
  'Refresh graphics, a label or a belly band while keeping the form.',
  'One master and 2–4 material and finish combinations.',
  'One material per image, with the same form, angle and layout.',
  'A gift-box brief and 1–4 real contents with quantities.',
  'An open-box arrangement with a conceptual inner tray.',
  'One master and 2–6 named SKUs with separate notes.',
  'One image per SKU, preserving the master brand hierarchy.',
  'One approved package and a photographic setting.',
  'Change the photographic environment, not the package design.',
  // 平铺服装类型与请求校验。
  'Garment top',
  'Garment bottom',
  'Matching set',
