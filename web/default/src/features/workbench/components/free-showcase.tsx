 ...
 * (garments, detail, reference, model, scene) flowing into one generated
 * commercial shot, so the workflow reads at a glance.
 */
      ...
      <div className='flex flex-wrap items-center justify-center gap-4 sm:gap-6'>
        <div className='relative'>
          <img
            src={freeSources}
            alt=''
            className='border-card bg-muted h-32 w-64 rounded-xl border-4 object-cover shadow-md'
          />
