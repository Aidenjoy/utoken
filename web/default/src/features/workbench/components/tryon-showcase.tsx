 ...
 * sources → result flow with actual example images so the user understands
      ...
      <div className='flex flex-wrap items-center justify-center gap-4 sm:gap-6'>
        <div className='relative'>
          <img
            src={multiSources}
            alt=''
            className='border-card bg-muted h-36 w-48 rounded-xl border-4 object-cover shadow-md'
          />
