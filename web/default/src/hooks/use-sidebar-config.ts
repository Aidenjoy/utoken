...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/organization/overview': { section: 'personal', module: 'organization' },
  '/organization/members': { section: 'personal', module: 'organization' },
  '/organization/usage': { section: 'personal', module: 'organization' },
  '/organization/billing': { section: 'personal', module: 'organization' },
  '/organization/settings': { section: 'personal', module: 'organization' },
